...
export class GamificationElementObject {
    ...
    constructor(imageSrc: string, elementName: string, details: string, ranking: number = 0, percentages: RecommendationPercentageObject = new RecommendationPercentageObject()) {
