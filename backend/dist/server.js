...
const RecommendationService_1 = __importDefault(require("./RecommenderSystem/RecommendationService"));
const ElementRepository_1 = __importDefault(require("./GamificationElementSystem/ElementRepository"));
